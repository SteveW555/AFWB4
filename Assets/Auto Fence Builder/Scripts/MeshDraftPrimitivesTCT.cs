...
namespace ProceduralToolkitTCT
{
    ...
    /// </summary>
    public partial class MeshDraftTCT
    {
        ...
        /// </summary>
        public static MeshDraftTCT Tetrahedron(float radius, bool generateUV = true)
        {
            const float tetrahedralAngle = -19.471220333f;

            var vertex0 = new Vector3(0, radius, 0);
            var vertex1 = GeometryTCT.PointOnSphere(radius, 0, tetrahedralAngle);
            var vertex2 = GeometryTCT.PointOnSphere(radius, 120, tetrahedralAngle);
            var vertex3 = GeometryTCT.PointOnSphere(radius, 240, tetrahedralAngle);

            MeshDraftTCT draft = new MeshDraftTCT { name = "Tetrahedron" };
            if (generateUV)
            {
        ...
        /// </summary>
        public static MeshDraftTCT Cube(float side, bool generateUV = true)
        {
            MeshDraftTCT draft = Hexahedron(side, side, side, generateUV);
            draft.name = "Cube";
            return draft;
        }
        ...
        /// </summary>
        public static MeshDraftTCT Hexahedron(float width, float length, float height, bool generateUV = true)
        {
        ...
        /// Constructs a hexahedron draft
        /// </summary>
        public static MeshDraftTCT Hexahedron(Vector3 width, Vector3 length, Vector3 height, bool generateUV = true)
        {
            ...
            MeshDraftTCT draft = new MeshDraftTCT { name = "Hexahedron" };
            if (generateUV)
            {
        ...
        /// </summary>
        public static MeshDraftTCT Octahedron(float radius, bool generateUV = true)
        {
            MeshDraftTCT draft = BiPyramid(radius, 4, radius * 2, generateUV);
        ...
        /// </summary>
        public static MeshDraftTCT Dodecahedron(float radius)
        {
            ...
            for (var i = 0; i < 5; i++)
            {
                lowerCap[i] = GeometryTCT.PointOnSphere(radius, lowerAngle, -magicAngle1);
                lowerRing[i] = GeometryTCT.PointOnSphere(radius, lowerAngle, -magicAngle2);
                upperCap[i] = GeometryTCT.PointOnSphere(radius, upperAngle, magicAngle1);
                upperRing[i] = GeometryTCT.PointOnSphere(radius, upperAngle, magicAngle2);
                lowerAngle += segmentAngle;
                upperAngle += segmentAngle;
            }

            MeshDraftTCT draft = new MeshDraftTCT { name = "Dodecahedron" }
        ...
        /// </summary>
        public static MeshDraftTCT Icosahedron(float radius, bool generateUV = true)
        {
            ...
            for (var i = 0; i < 5; i++)
            {
                lowerRing[i] = GeometryTCT.PointOnSphere(radius, lowerAngle, -magicAngle);
                upperRing[i] = GeometryTCT.PointOnSphere(radius, upperAngle, magicAngle);
                lowerAngle += segmentAngle;
                upperAngle += segmentAngle;
            }

            MeshDraftTCT draft = new MeshDraftTCT { name = "Icosahedron" }
        ...
        /// </summary>
        public static MeshDraftTCT Quad(Vector3 origin, Vector3 width, Vector3 height, bool generateUV = true)
        {
            MeshDraftTCT draft = new MeshDraftTCT { name = "Quad" };
            if (generateUV)
            {
        ...
        /// Constructs a quad draft
        /// </summary>
        public static MeshDraftTCT Quad(Vector3 vertex0, Vector3 vertex1, Vector3 vertex2, Vector3 vertex3, bool generateUV = true)
        {
            MeshDraftTCT draft = new MeshDraftTCT { name = "Quad" };
            if (generateUV)
            {
        ...
        /// </summary>
        public static MeshDraftTCT Plane(float xSize = 1, float zSize = 1, int xSegments = 1, int zSegments = 1, bool generateUV = true)
        {
            float xStep = xSize / xSegments;
            float zStep = zSize / zSegments;
            var vertexCount = (xSegments + 1) * (zSegments + 1);
            MeshDraftTCT draft = new MeshDraftTCT
            {
                name = "Plane",
        ...
        /// </summary>
        public static MeshDraftTCT Pyramid(float radius, int segments, float height, bool generateUV = true)
        {
            ...
            {
                ring[i] = GeometryTCT.PointOnCircle3XZ(radius, currentAngle);
                currentAngle += segmentAngle;
            }

            MeshDraftTCT draft = new MeshDraftTCT().AddBaselessPyramid(Vector3.up * height, ring, generateUV);
            if (generateUV)
            {
                ...
                for (var i = 0; i < segments; i++)
                {
                    Vector2 uv = GeometryTCT.PointOnCircle2TCT(0.5f, currentAngle) + new Vector2(0.5f, 0.5f);
                    uv.x = 1 - uv.x;
                    fanUV[i] = uv;
                    currentAngle += segmentAngle;
                }
        ...
        /// </summary>
        public static MeshDraftTCT BiPyramid(float radius, int segments, float height, bool generateUV = true)
        {
            float segmentAngle = 360f / segments;
            float currentAngle = 0;
            ...
            MeshDraftTCT draft = new MeshDraftTCT { name = "Bipyramid" }
        ...
        /// </summary>
        public static MeshDraftTCT Prism(float radius, int segments, float height, bool generateUV = true)
        {
            float segmentAngle = 360f / segments;
            float currentAngle = 0;
            ...
            for (var i = 0; i < segments; i++)
            {
                var point = GeometryTCT.PointOnCircle3XZ(radius, currentAngle);
            ...
            MeshDraftTCT draft = new MeshDraftTCT { name = "Prism" }
        ...
        /// </summary>
        public static MeshDraftTCT Cylinder(float radius, int segments, float height, bool generateUV = true)
        {
            float segmentAngle = 360f / segments;
            float currentAngle = 0;
            Vector3 halfHeightUp = Vector3.up * height / 2;

            MeshDraftTCT draft = new MeshDraftTCT { name = "Cylinder" };
            var lowerRing = new List<Vector3>(segments);
            var lowerDiskUV = new List<Vector2>();
            var upperRing = new List<Vector3>(segments);
            var upperDiskUV = new List<Vector2>();
        ...
        {
            Vector3 normal = GeometryTCT.PointOnCircle3XZ(1, currentAngle);
        ...
        /// </summary>
        public static MeshDraftTCT FlatSphere(float radius, int horizontalSegments, int verticalSegments, bool generateUV = true)
        {
            MeshDraftTCT draft = FlatSpheroid(radius, radius, horizontalSegments, verticalSegments, generateUV);
        ...
        /// </summary>
        public static MeshDraftTCT FlatSpheroid(float radius, float height, int horizontalSegments, int verticalSegments, bool generateUV = true)
        {
            MeshDraftTCT draft = FlatRevolutionSurface(GeometryTCT.PointOnSpheroid, radius, height, horizontalSegments, verticalSegments, generateUV);
        ...
        /// </summary>
        public static MeshDraftTCT FlatTeardrop(float radius, float height, int horizontalSegments, int verticalSegments, bool generateUV = true)
        {
            MeshDraftTCT draft = FlatRevolutionSurface(GeometryTCT.PointOnTeardrop, radius, height, horizontalSegments, verticalSegments, generateUV);
        ...
        /// </summary>
        public static MeshDraftTCT FlatRevolutionSurface(
            ...
            bool generateUV = true)
        {
            ...
            MeshDraftTCT draft = new MeshDraftTCT { name = "Flat revolution surface" };
        ...
        /// </summary>
        public static MeshDraftTCT Sphere(float radius, int horizontalSegments, int verticalSegments, bool generateUV = true)
        {
            MeshDraftTCT draft = Spheroid(radius, radius, horizontalSegments, verticalSegments, generateUV);
            draft.name = "SphereTCT";
            return draft;
        }
        ...
        /// </summary>
        public static MeshDraftTCT Spheroid(float radius, float height, int horizontalSegments, int verticalSegments, bool generateUV = true)
        {
            MeshDraftTCT draft = RevolutionSurface(GeometryTCT.PointOnSpheroid, radius, height, horizontalSegments, verticalSegments, generateUV);
            draft.name = "Spheroid";
            return draft;
        }
        ...
        /// </summary>
        public static MeshDraftTCT Teardrop(float radius, float height, int horizontalSegments, int verticalSegments, bool generateUV = true)
        {
            MeshDraftTCT draft = RevolutionSurface(GeometryTCT.PointOnTeardrop, radius, height, horizontalSegments, verticalSegments, generateUV);
            draft.name = "Teardrop";
            return draft;
        }
        ...
        /// </summary>
        public static MeshDraftTCT RevolutionSurface(
            Func<float, float, float, float, Vector3> surfaceFunction,
            float radius,
            float height,
            int horizontalSegments,
            ...
            bool generateUV = true)
        {
            MeshDraftTCT draft = new MeshDraftTCT { name = "Revolution surface" };
        ...
        /// </summary>
        public static MeshDraftTCT PartialBox(Vector3 width, Vector3 depth, Vector3 height, DirectionsTCT parts, bool generateUV = true)
        {
            ...
            MeshDraftTCT draft = new MeshDraftTCT { name = "Partial box" };
            ...
            if (generateUV)
            {
                ...
                if (parts.HasFlag(DirectionsTCT.Left)) draft.AddQuad(v100, v101, v001, v000, true, uv0, uv1, uv2, uv3);
                if (parts.HasFlag(DirectionsTCT.Right)) draft.AddQuad(v010, v011, v111, v110, true, uv0, uv1, uv2, uv3);
                if (parts.HasFlag(DirectionsTCT.Down)) draft.AddQuad(v010, v110, v100, v000, true, uv0, uv1, uv2, uv3);
                if (parts.HasFlag(DirectionsTCT.Up)) draft.AddQuad(v111, v011, v001, v101, true, uv0, uv1, uv2, uv3);
                if (parts.HasFlag(DirectionsTCT.Back)) draft.AddQuad(v000, v001, v011, v010, true, uv0, uv1, uv2, uv3);
                if (parts.HasFlag(DirectionsTCT.Forward)) draft.AddQuad(v110, v111, v101, v100, true, uv0, uv1, uv2, uv3);
            }
            else
            {
                if (parts.HasFlag(DirectionsTCT.Left)) draft.AddQuad(v100, v101, v001, v000, true);
                if (parts.HasFlag(DirectionsTCT.Right)) draft.AddQuad(v010, v011, v111, v110, true);
                if (parts.HasFlag(DirectionsTCT.Down)) draft.AddQuad(v010, v110, v100, v000, true);
                if (parts.HasFlag(DirectionsTCT.Up)) draft.AddQuad(v111, v011, v001, v101, true);
                if (parts.HasFlag(DirectionsTCT.Back)) draft.AddQuad(v000, v001, v011, v010, true);
                if (parts.HasFlag(DirectionsTCT.Forward)) draft.AddQuad(v110, v111, v101, v100, true);
            }
            return draft;
        }
        ...
        public static MeshDraftTCT Capsule(float height, float radius, int segments = 32, int rings = 8)
        {
            ...
            for (int s = 0; s < segments; s++)
            {
                ...
                {
                    // Top cap vertex
                    Vector3 normal = GeometryTCT.PointOnSphere(1, s * horizontalAngle, 90 - r * verticalAngle);
