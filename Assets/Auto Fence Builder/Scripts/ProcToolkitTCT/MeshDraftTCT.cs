...
// Have Duplicated and Modified the original MeshDraftTCT.cs from ProceduralToolkit
...
namespace ProceduralToolkitTCT
{
    ...
    public partial class MeshDraftTCT
    {
        ...
        /// <summary>
        /// Creates a new MeshDraftTCT with vertex data from the <paramref name="mesh"/>>
        /// </summary>
        public MeshDraftTCT(Mesh mesh)
        {
        ...
        /// </summary>
        public MeshDraftTCT Add(MeshDraftTCT draft)
        {
        ...
        /// </summary>
        public MeshDraftTCT AddTriangle(Vector3 vertex0, Vector3 vertex1, Vector3 vertex2, bool calculateNormal)
        {
            if (calculateNormal)
            {
        ...
        /// Adds a triangle to the draft
        /// </summary>
        public MeshDraftTCT AddTriangle(Vector3 vertex0, Vector3 vertex1, Vector3 vertex2, Vector3 normal)
        {
            return AddTriangle(vertex0, vertex1, vertex2, normal, normal, normal);
        }
        ...
        /// Adds a triangle to the draft
        /// </summary>
        public MeshDraftTCT AddTriangle(Vector3 vertex0, Vector3 vertex1, Vector3 vertex2, Vector3 normal0, Vector3 normal1, Vector3 normal2)
        {
            normals.Add(normal0);
            normals.Add(normal1);
            normals.Add(normal2);
        ...
        private MeshDraftTCT _AddTriangle(Vector3 vertex0, Vector3 vertex1, Vector3 vertex2)
        {
        ...
        /// </summary>
        public MeshDraftTCT AddQuad(Vector3 origin, Vector3 width, Vector3 height, bool calculateNormal)
        {
        ...
        /// Adds a quad to the draft
        /// </summary>
        public MeshDraftTCT AddQuad(Vector3 vertex0, Vector3 vertex1, Vector3 vertex2, Vector3 vertex3, bool calculateNormal)
        {
            if (calculateNormal)
            {
                ...
                float Epsilon = 0.00001f; // From ProceduralToolkit GeometryTCT.cs
        ...
        /// Adds a quad to the draft
        /// </summary>
        public MeshDraftTCT AddQuad(Vector3 vertex0, Vector3 vertex1, Vector3 vertex2, Vector3 vertex3, Vector3 normal)
        {
            return AddQuad(vertex0, vertex1, vertex2, vertex3, normal, normal, normal, normal);
        }
        ...
        /// Adds a quad to the draft
        /// </summary>
        public MeshDraftTCT AddQuad(Vector3 vertex0, Vector3 vertex1, Vector3 vertex2, Vector3 vertex3,
        ...
        private MeshDraftTCT _AddQuad(Vector3 vertex0, Vector3 vertex1, Vector3 vertex2, Vector3 vertex3)
        {
            triangles.Add(0 + vertices.Count);
            triangles.Add(1 + vertices.Count);
            triangles.Add(2 + vertices.Count);
        ...
        /// </remarks>
        public MeshDraftTCT AddTriangleFan(IList<Vector3> fan, bool reverseTriangles = false)
        {
        ...
        /// https://en.wikipedia.org/wiki/Triangle_fan
        /// </remarks>
        public MeshDraftTCT AddTriangleFan(IList<Vector3> fan, Vector3 normal, bool reverseTriangles = false)
        {
        ...
        /// https://en.wikipedia.org/wiki/Triangle_fan
        /// </remarks>
        public MeshDraftTCT AddTriangleFan(IList<Vector3> fan, IList<Vector3> normals, bool reverseTriangles = false)
        {
            AddTriangleFanVertices(fan, reverseTriangles);
        ...
        /// https://en.wikipedia.org/wiki/Triangle_fan
        /// </remarks>
        public MeshDraftTCT AddTriangleFan(IList<Vector3> fan, IList<Vector2> uv, bool reverseTriangles = false)
        {
            this.uv.AddRange(uv);
        ...
        /// https://en.wikipedia.org/wiki/Triangle_fan
        /// </remarks>
        public MeshDraftTCT AddTriangleFan(IList<Vector3> fan, Vector3 normal, IList<Vector2> uv, bool reverseTriangles = false)
        {
            this.uv.AddRange(uv);
            return AddTriangleFan(fan, normal, reverseTriangles);
        }
        ...
        /// https://en.wikipedia.org/wiki/Triangle_fan
        /// </remarks>
        public MeshDraftTCT AddTriangleFan(IList<Vector3> fan, IList<Vector3> normals, IList<Vector2> uv, bool reverseTriangles = false)
        {
            this.uv.AddRange(uv);
        ...
        /// </remarks>
        public MeshDraftTCT AddTriangleStrip(IList<Vector3> strip)
        {
        ...
        /// https://en.wikipedia.org/wiki/Triangle_strip
        /// </remarks>
        public MeshDraftTCT AddTriangleStrip(IList<Vector3> strip, Vector3 normal)
        {
            for (int i = 0, j = 1, k = 2;
                i < strip.Count - 2;
                i++, j += i % 2 * 2, k += (i + 1) % 2 * 2)
        ...
        /// https://en.wikipedia.org/wiki/Triangle_strip
        /// </remarks>
        public MeshDraftTCT AddTriangleStrip(IList<Vector3> strip, IList<Vector3> normals)
        {
            for (int i = 0, j = 1, k = 2;
                i < strip.Count - 2;
                i++, j += i % 2 * 2, k += (i + 1) % 2 * 2)
        ...
        /// https://en.wikipedia.org/wiki/Triangle_strip
        /// </remarks>
        public MeshDraftTCT AddTriangleStrip(IList<Vector3> strip, IList<Vector2> uv)
        {
            this.uv.AddRange(uv);
        ...
        /// https://en.wikipedia.org/wiki/Triangle_strip
        /// </remarks>
        public MeshDraftTCT AddTriangleStrip(IList<Vector3> strip, Vector3 normal, IList<Vector2> uv)
        {
            this.uv.AddRange(uv);
            return AddTriangleStrip(strip, normal);
        }
        ...
        /// https://en.wikipedia.org/wiki/Triangle_strip
        /// </remarks>
        public MeshDraftTCT AddTriangleStrip(IList<Vector3> strip, IList<Vector3> normals, IList<Vector2> uv)
        {
            this.uv.AddRange(uv);
        ...
        /// </summary>
        public MeshDraftTCT AddBaselessPyramid(Vector3 apex, IList<Vector3> ring, bool generateUV, bool reverseTriangles = false)
        {
            if (generateUV)
            {
        ...
        /// </summary>
        public MeshDraftTCT AddFlatTriangleBand(IList<Vector3> lowerRing, IList<Vector3> upperRing, bool generateUV)
        {
        ...
        /// </summary>
        public MeshDraftTCT AddFlatQuadBand(IList<Vector3> lowerRing, IList<Vector3> upperRing, bool generateUV)
        {
            if (lowerRing.Count != upperRing.Count)
            {
                throw new ArgumentException("Array sizes must be equal");
        ...
        /// </summary>
        public MeshDraftTCT Move(Vector3 vector)
        {
        ...
        /// </summary>
        public MeshDraftTCT Rotate(Quaternion rotation)
        {
            for (int i = 0; i < vertices.Count; i++)
            {
        ...
        /// </summary>
        public MeshDraftTCT Scale(float scale)
        {
            for (int i = 0; i < vertices.Count; i++)
            {
                vertices[i] *= scale;
        ...
        /// </summary>
        public MeshDraftTCT Scale(Vector3 scale)
        {
            for (int i = 0; i < vertices.Count; i++)
            {
        ...
        /// </summary>
        public MeshDraftTCT Paint(Color color)
        {
            colors.Clear();
            for (int i = 0; i < vertices.Count; i++)
            {
        ...
        /// </summary>
        public MeshDraftTCT FlipTriangles()
        {
        ...
        /// </summary>
        public MeshDraftTCT FlipNormals()
        {
        ...
        /// </summary>
        public MeshDraftTCT FlipUVHorizontally(int channel = 0)
        {
            List<Vector2> list;
            switch (channel)
            {
        ...
        /// </summary>
        public MeshDraftTCT FlipUVVertically(int channel = 0)
        {
            List<Vector2> list;
            switch (channel)
            {
        ...
        /// </summary>
        public MeshDraftTCT Spherify(float radius, Vector3 center = default)
        {
        ...
        {
            return name + " (ProceduralToolkit.MeshDraftTCT)";
        }
    }
}