...
namespace ProceduralToolkitTCT
{
    ...
    /// </summary>
    public static class GeometryTCT
    {
        /// <summary>
        ...
        public static Vector2 PointOnSegment2TCT(Vector2 segmentA, Vector2 segmentB, float position)
        {
        ...
        public static List<Vector2> PointsOnSegment2TCT(Vector2 segmentA, Vector2 segmentB, int count)
        {
            ...
            {
                points.Add(PointOnSegment2TCT(segmentA, segmentB, i / (float)(count - 1)));
            }
            return points;
        }

        #region PointOnCircle2TCT
        ...
        public static Vector2 PointOnCircle2TCT(float radius, float angle)
        {
        ...
        /// <param name="radius">Circle radius</param>
        /// <param name="angle">Angle in degrees</param>
        public static Vector2 PointOnCircle2TCT(Vector2 center, float radius, float angle)
        {
            return center + PointOnCircle2TCT(radius, angle);
        }

        #endregion PointOnCircle2TCT

        #region PointsOnCircle2TCT
        ...
        /// <param name="radius">Circle radius</param>
        /// <param name="count">Number of points</param>
        public static List<Vector2> PointsOnCircle2TCT(float radius, int count)
        {
            ...
            {
                points.Add(PointOnCircle2TCT(radius, currentAngle));
        ...
        /// <param name="radius">Circle radius</param>
        /// <param name="count">Number of points</param>
        public static List<Vector2> PointsOnCircle2TCT(Vector2 center, float radius, int count)
        {
            float segmentAngle = 360f / count;
            float currentAngle = 0;
            var points = new List<Vector2>(count);
            for (var i = 0; i < count; i++)
            {
                points.Add(PointOnCircle2TCT(center, radius, currentAngle));
                currentAngle += segmentAngle;
            }
            return points;
        }

        #endregion PointsOnCircle2TCT

        #region PointsInCircle2TCT
        ...
        /// <param name="radius">Circle radius</param>
        /// <param name="count">Number of points</param>
        public static List<Vector2> PointsInCircle2TCT(float radius, int count)
        {
            float currentAngle = 0;
            var points = new List<Vector2>(count);
            for (int i = 0; i < count; i++)
            {
                ...
                currentAngle += PTUtilsTCT.GoldenAngle;
            }
            return points;
        }
        ...
        /// <param name="radius">Circle radius</param>
        /// <param name="count">Number of points</param>
        public static List<Vector2> PointsInCircle2TCT(Vector2 center, float radius, int count)
        {
            float currentAngle = 0;
            var points = new List<Vector2>(count);
            for (int i = 0; i < count; i++)
        ...
        /// </summary>
        /// <param name="radius">SphereTCT radius</param>
        ...
        {
            return PointsOnCircle2TCT(radius, vertices);
        }
        ...
        public static List<Vector2> StarPolygon2(int vertices, float innerRadius, float outerRadius)
        {
            ...
            {
                polygon.Add(PointOnCircle2TCT(outerRadius, currentAngle));
                polygon.Add(PointOnCircle2TCT(innerRadius, currentAngle + halfSegmentAngle));
                currentAngle += segmentAngle;
            }
            return polygon;
        }
        ...
        public static float GetAngle(Vector2 previous, Vector2 current, Vector2 next)
        {
            ...
            return VectorETCT.Angle360(toNext, toPrevious);
        }
        ...
        public static Vector2 GetAngleBisector(Vector2 previous, Vector2 current, Vector2 next, out float degrees)
        {
            ...
            degrees = VectorETCT.Angle360(toNext, toPrevious);
