...
namespace ProceduralToolkitTCT
{
    ...
    /// Vector extensions
    /// </summary>
    public static class VectorETCT
    {
        #region Vector2
        ...
        {
            return Mathf.Abs(PerpDot(vector, other)) < GeometryTCT.Epsilon;
        }
        ...
        {
            return new Vector2((vector.x + vector.y) * PTUtilsTCT.Sqrt05, (vector.y - vector.x) * PTUtilsTCT.Sqrt05);
        }
