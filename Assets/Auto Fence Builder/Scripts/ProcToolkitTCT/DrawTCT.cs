...
namespace ProceduralToolkitTCT
{
    ...
    /// </summary>
    public static partial class DrawTCT
    {
        ...
        static DrawTCT()
        {
            pointOnCircleXY = GeometryTCT.PointOnCircle3XY;
            pointOnCircleXZ = GeometryTCT.PointOnCircle3XZ;
            pointOnCircleYZ = GeometryTCT.PointOnCircle3YZ;
        }
        ...
        /// Draws a segment
        /// </summary>
        public static void Segment2TCT(Action<Vector3, Vector3> drawLine, Segment2TCT segment)
        {
        ...
        /// Draws a segment
        /// </summary>
        public static void Segment2TCT(DebugDrawLine drawLine, Segment2TCT segment, Color color, float duration, bool depthTest)
        {
            drawLine((Vector3) segment.a, (Vector3) segment.b, color, duration, depthTest);
        }

        #endregion Segment2TCT
        ...
        /// Draws a segment
        /// </summary>
        public static void Segment3(Action<Vector3, Vector3> drawLine, Segment3TCT segment)
        {
        ...
        /// Draws a segment
        /// </summary>
        public static void Segment3(DebugDrawLine drawLine, Segment3TCT segment, Color color, float duration, bool depthTest)
        {
            ...
            float length)
        {
            ...
            Vector3 a2 = baseCenter + rotation*GeometryTCT.PointOnCircle3XZ(baseRadius, 0);
            Vector3 b2 = baseCenter + rotation*GeometryTCT.PointOnCircle3XZ(baseRadius, 90);
            Vector3 c2 = baseCenter + rotation*GeometryTCT.PointOnCircle3XZ(baseRadius, 180);
            Vector3 d2 = baseCenter + rotation*GeometryTCT.PointOnCircle3XZ(baseRadius, 270);
            ...
            else
            {
                ...
                Vector3 a1 = position + rotation*GeometryTCT.PointOnCircle3XZ(apexRadius, 0);
                Vector3 b1 = position + rotation*GeometryTCT.PointOnCircle3XZ(apexRadius, 90);
                Vector3 c1 = position + rotation*GeometryTCT.PointOnCircle3XZ(apexRadius, 180);
                Vector3 d1 = position + rotation*GeometryTCT.PointOnCircle3XZ(apexRadius, 270);
            ...
            Color color, float duration, bool depthTest)
        {
            ...
            Vector3 a2 = upperCenter + rotation*GeometryTCT.PointOnCircle3XZ(upperRadius, 0);
            Vector3 b2 = upperCenter + rotation*GeometryTCT.PointOnCircle3XZ(upperRadius, 90);
            Vector3 c2 = upperCenter + rotation*GeometryTCT.PointOnCircle3XZ(upperRadius, 180);
            Vector3 d2 = upperCenter + rotation*GeometryTCT.PointOnCircle3XZ(upperRadius, 270);
