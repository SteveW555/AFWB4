...
public class AutoFenceConfigurationManager : ScriptableObject
{
    ...
    {
        //List<ScriptablePresetAFWB> mainPresetList = new List<ScriptablePresetAFWB>();
        //string presetFilePath = "Assets/Auto Fence Builder/AFWB_Presets";

        bool mainPresetFolderExists = AssetDatabase.IsValidFolder(af.currAutoFenceBuilderDir);
        ...
        string configFilePath = af.currAutoFenceBuilderDir + "/Editor/AutoFenceConfig.asset";
